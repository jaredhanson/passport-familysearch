...
function Strategy(options, verify) {
  ...
  this._authorizationURL = options.authorizationURL || "https://ident.familysearch.org/cis-web/oauth2/v3/authorization";
  this._tokenURL = options.tokenURL || "https://ident.familysearch.org/cis-web/oauth2/v3/token";
;
